      ...
      <div class="header-top-area">
          <div class="container">
              <div class="row">
                  ...
                  <div class="col-sm-3">
                      <div class="logo">
                          <a href="index.html">RadionCoding</a>
                      </div>
                  </div>
      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-sm-offset-2 col-md-4 col-sm-6 margin-left-setting">
                  <div class="margin-top-150">
                      ...
                      <div class="table-responsive">
                          <img class="cdh" src="images/bg/codehead.webp"></img>
                          <table class="table">
                              <tr>
                                  <td>Name</td>
                                  <td>Radion Barilo</td>
                              ...
                              <tr>
                                  <td>Contact</td>
                                  <td>38(063)768-55-08</td>
                              </tr>
                              <tr>
                                  <td>Resume</td>
                                  <td style="background-color: #ff2020;"><a href="https://www.upwork.com/freelancers/~01c9bdb5792e5c1a73" target="_blank" data-toggle="tooltip" data-placement="top" title="Check Out My Resume">Resume.pdf</a></td>
                              </tr>
                          </table>
                      </div>
                  </div>
              ...
              <div class="col-md-5 col-sm-6">
                  <div class="me-image">
                      <img src="images/bg/top.jpeg" alt="">
                  </div>
              </div>
          </div>
      </div>
          ...
          <div class="row">
              <div class="col-sm-12">
                  <div class="section-title">
                      ...
                      <p>I always make projects more interesting than others
                          all about my experience in programming</p>
                  </div>
              </div>
          </div>
              ...
              <div class="col-md-offset-3 col-sm-offset-2 col-md-6 col-sm-8">
                  <div class="testimonial-carousel-list margin-top-20">
                      ...
                      <div class="testimonial-word text-center">
                          ...
                          <h2>Radion Barilo</h2>
                          <p>@xbox_ukr - creator and head of XBOX UKRAINE gaming community.</p>
                      </div>
                      ...
                      <div class="testimonial-word text-center">
                          ...
                          <h2>Petro Klymivskyi</h2>
                          <p>Congratulations! Get ready to become a cool programmer ;)</p>
                      </div>
